...
export const LearnSection = () => {
  return (
    <section className="bg-[#0F172A] px-5 font-roboto font-bold text-xl flex flex-col lg:flex-row justify-center pb-20">
      <div className="max-w-[500px] lg:flex-1/2">
        ...
        <Link to="#" className="inline-flex gap-2 mb-10">
          <p className="text-white hover:underline">Explorer les ressources</p><RiArrowRightLine color="white" />
        </Link>
      </div>
